...
const getGuessTemperatureTemplate = (cityInfo, results) => (
  `<div class="guess">
    ...
    <div class="guess__result">
      <div class="real">True answer: ${results.real}</div>
      <div class="user">Your answer: ${results.user}</div>
      <div class="diff">Difference: ${results.diff >= 0 ? `+${results.diff}` : String(results.diff)}</div>
    </div>
