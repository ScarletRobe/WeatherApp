...
const getScoreboardTemplate = () => (
  `<div class="scoreboard">
  <h1 class="scoreboard__header">You scored: 25!</h1>
  <h2 class="scoreboard__description vh">Your place in scoreboard: 1!</h2>
